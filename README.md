...
- **Natural Language to SQL**: Converts natural language queries into SQL using Google's GPT models
...
Converts natural language queries to SQL using Google's GPT-4:
