...
- **Natural Language to SQL**: Converts natural language queries into SQL using Anthropic's GPT models
...
Converts natural language queries to SQL using Anthropic's GPT-4:
